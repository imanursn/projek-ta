 ...
 * @author lenovo
 */
public class E_Jabatan extends javax.swing.JFrame {

    /**
     * Creates new form E_Jabatan
     */
    public E_Jabatan() {
        initComponents();
    ...
    private String jabatan; // Variabel untuk menyimpan nama_divisi lama

    // Method Setter untuk menerima nama_divisi lama dari form lain
    public void setJabatan(String jabatan) {
    this.jabatan = jabatan; // Simpan nama_divisi lama
    Input.setText(jabatan); // Set nilai input dengan nama lama
}
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        try (Connection conn = db_connect.connect()) {
            ...
            String sql = "DELETE FROM jabatan WHERE nama_jabatan = ?";
    ...
    try (Connection conn = db_connect.connect()) {
        ...
        String sql = "UPDATE jabatan SET nama_jabatan = ? WHERE nama_jabatan = ?";
        PreparedStatement stmt = conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(E_Jabatan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
